...
public class Bank2UserInformationController implements Initializable {
    Main main = new Main();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        fm.FileReader("src\\main\\resources\\Files\\User\\AddUser\\Bank2\\Name.txt",firstName);
        fm.FileReader("src\\main\\resources\\Files\\User\\AddUser\\Bank2\\LastName.txt",lastName);
        fm.FileReader("src\\main\\resources\\Files\\User\\AddUser\\Bank2\\Age.txt",age);
        fm.FileReader("src\\main\\resources\\Files\\User\\AddUser\\Bank2\\AccountCredit.txt",money);
