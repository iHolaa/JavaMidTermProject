...
public class AddAdminForBank2 {
    ...
    public void AddAdminForBank2(){
        if(adminPassword.getText().length() > 3 && adminUsername.getText().length() > 3){
            fm2.FileWriter("D:\\JavaBank\\Main\\Files\\Bank2 Admin SignUp\\Username.txt",
                    adminUsername.getText().trim());
            fm2.FileWriter("D:\\JavaBank\\Main\\Files\\Bank2 Admin SignUp\\Password.txt",
