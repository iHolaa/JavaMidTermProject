...
public class HeadBankUserInfoController implements Initializable {
    Main main = new Main();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        fm.FileReader("src\\main\\resources\\Files\\User\\AddUser\\HeadBank\\Name.txt",firstName);
        fm.FileReader("src\\main\\resources\\Files\\User\\AddUser\\HeadBank\\LastName.txt",lastName);
        fm.FileReader("src\\main\\resources\\Files\\User\\AddUser\\HeadBank\\Age.txt",age);
        fm.FileReader("src\\main\\resources\\Files\\User\\AddUser\\HeadBank\\AccountCredit.txt",money);
