...
public class Bank1UserInformationController implements Initializable {
    Main main = new Main();
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        fm.FileReader("src\\main\\resources\\Files\\User\\AddUser\\Bank1\\Name.txt",firstName);
        fm.FileReader("src\\main\\resources\\Files\\User\\AddUser\\Bank1\\LastName.txt",lastName);
        fm.FileReader("src\\main\\resources\\Files\\User\\AddUser\\Bank1\\Age.txt",age);
        fm.FileReader("src\\main\\resources\\Files\\User\\AddUser\\Bank1\\AccountCredit.txt",money);
