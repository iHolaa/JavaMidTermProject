...
public class AddAdminForBank3 {
    ...
    public void AddAdminForBank3(){
        if(adminPassword.getText().length() > 3 && adminUsername.getText().length() > 3){
            fm2.FileWriter("src\\main\\resources\\Files\\Login Admin\\Bank3 Admin SignUp\\Username.txt",
                    adminUsername.getText().trim());
            fm2.FileWriter("src\\main\\resources\\Files\\Login Admin\\Bank3 Admin SignUp\\Password.txt",
